      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-brand">
            <div className="logo">Dent<span>vital</span></div>
            <p>
              Nowoczesna klinika stomatologiczna w centrum Szczecina. Kompleksowa
              opieka oraz indywidualne podejście do każdego pacjenta.
            </p>
          </div>
          ...
          <div className="footer-col">
            ...
            <p>{CLINIC.addressShort}<br />{CLINIC.city}</p>
            <p style={{ marginTop: 8 }}>
              <a href={`tel:${CLINIC.phoneRaw}`}>{CLINIC.phone}</a><br />
          ...
          <div className="footer-col">
            ...
            <p style={{ marginTop: 12 }}>Wkrótce udostępnimy profile społecznościowe.</p>
          </div>
        </div>

        <div className="footer-bottom">
          <span>&copy; {year} Dentvital. Wszelkie prawa zastrzeżone.</span>
          <span>Zaprojektowano w Szczecinie</span>
        </div>
      </div>
    </footer>
  );
